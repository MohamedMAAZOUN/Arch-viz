...
elements += [
    el("api-gateway", "service", "API Gateway", "mvp1", parent="platform-domain",
       ...
       tone="critical",
       dataSources=[{"kind": "grafana", "query": "gateway_rps", "binding": "metric"}]),
...
elements += [
    el("payment-service", "service", "Payment Service", "mvp2",
       ...
       properties={"description": "Initiates and tracks payments.",
                   ...
                   "tech": {"language": "Java"}},
       dataSources=[{"kind": "jira", "jql": "project=PAY AND status=Open",
                     "binding": "badge"}]),
...
elements += [
    el("fraud-service", "service", "Fraud Detection", "mvp4",
       ...
       tone="warning",
       dataSources=[{"kind": "grafana", "query": "fraud_score_p99",
                     "binding": "metric"}]),
...
elements += [
    ...
    el("observability", "service", "Observability", "mvp1",
       ...
       dataSources=[{"kind": "grafana", "query": "up", "binding": "status"}]),
